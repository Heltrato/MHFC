...
import com.heltrato.mhfc.entity.client.render.FelyneRenderer;
import com.heltrato.mhfc.entity.client.render.PopoRenderer;
...
public class EntitiesMH {
	...
	static EntityType<FelyneEntity> FELYNE_ENTITY_TYPE = EntityType.Builder
			.create(FelyneEntity::new, EntityClassification.CREATURE).size(0.4F, 0.4F).build("felyne");
	static RegistryObject<EntityType<FelyneEntity>> FELYNE_OBJECT = MOD_ENTITY.register("felyne",
			() -> FELYNE_ENTITY_TYPE);
	...
	static RegistryObject<EntityType<PopoEntity>> POPO_OBJECT = MOD_ENTITY.register("popo", () -> POPO_ENTITY_TYPE);
	...
	public static void addEntitySpawnPlacement() {
		EntitySpawnPlacementRegistry.register(FELYNE_ENTITY_TYPE, PlacementType.ON_GROUND,
				Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, FelyneEntity::canSpawnOn);
